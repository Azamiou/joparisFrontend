...
import { ViewContactUsComponent } from './components/view-contact-us/view-contact-us.component';
...
const routes: Routes = [
  ...
  { path: 'view-contact-us', component: ViewContactUsComponent, canActivate: [AdminGuard] },
];
