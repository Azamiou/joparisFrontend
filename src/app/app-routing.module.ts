...
import { ContactUsComponent } from './auth/auth-components/contact-us/contact-us.component';
...
const routes: Routes = [
  ...
  { path: 'contact-us', component: ContactUsComponent, canActivate: [NoAuthGuard] },
